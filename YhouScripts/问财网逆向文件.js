...
Document.prototype.attachEvent = function (x1, x2) {
    this[x1] = x2;
};
Document.prototype.addBehavior = function () {
    debugger;
};
...
Navigator.prototype.userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36";
...
Location.prototype.href = "http://iwencai.com/unifiedwap/inforesult?w=%E6%9C%89%E6%9C%BA%E7%A1%85%E6%A6%82%E5%BF%B5&querytype=info&active=passive"
...
//
function get_m() {
    var TOKEN_SERVER_TIME = 1631544997.988;
    !function (n, t, r, e, a, u, c) {
        !function () {
            ...
            var ct;
            !function (o) {
                var i = t[62], s = at(En, et, a[99]), v = u[19], f = c[33], l = e[44], d = r[56],
                    p = parseInt(i + An + s, c[30]), g = a[100], m = parseInt(u[69], a[11]), I = e[75], _ = e[76],
                    y = (h,
                        R,
                        e[77]), E = parseInt(Gn(n[81], cn), a[101]), A = parseInt(r[78], t[29]),
                    C = parseInt(t[31], c[28]), b = parseInt(c[72], u[70]), B = parseInt(a[102], c[31]), k = t[69],
                    T = parseInt(r[79], t[29]), O = parseInt(t[70], e[76]), S;
            ...
            var vt;
            !function (o) {
                var i = r[83], s = t[71], v = t[72], f = e[78], l = u[71], p = r[84], m = Zn(tn, d, n[82]), I = a[106],
                    _ = t[73], y = st(u[72], r[85], r[86]), A = c[74], b = c[75], k = r[87], T = u[73],
                    x = !!r[60][i + s + v + Cn], L, M, N, P, D, j;
